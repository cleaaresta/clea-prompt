      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <InputField 
            ...
            placeholder="Contoh: Robby Sugara"
          />
          ...
          {isFormValid ? (
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-all transform active:scale-95">
              Simpan Data
            </button>
          ) : (
